...
export function Hero({ content }: HeroProps) {
  ...
  return (
    <section id="hero" aria-labelledby="hero-heading" className="px-4 pt-6 pb-4 sm:pt-10 sm:pb-6">
      <div className="relative mx-auto flex min-h-[calc(100svh-6.5rem)] w-full max-w-3xl flex-col items-center justify-center overflow-hidden border border-olive-line px-5 py-14 text-center sm:min-h-[calc(100svh-8rem)] sm:px-12">
        <div
          aria-hidden="true"
        ...
        <div className="relative flex flex-col items-center">
          ...
          <p className="mt-8 font-body text-xl text-dark-gray italic sm:text-2xl">
            {content.title}
          </p>
          ...
          {content.body ? (
            <Markdown
              text={content.body}
              className="mt-7 max-w-md font-body text-lg leading-relaxed text-ink sm:text-xl"
            />
          ) : null}
          ...
          {countdown ? (
            <div
              ...
              className="mt-10 bg-deep-olive px-5 py-4 sm:px-8"
            >
